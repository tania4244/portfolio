...
const Contact = () => {
  return (
    <section id="contact" className="bg-gray-200 text-black">
      <div className="max-w-screen-2xl px-6 w-full pt-4 pb-16 md:pb-20 mx-auto">
        <h1 className="text-2xl md:text-3xl font-extrabold text-center uppercase lg:text-4xl py-6 md:py-8 text-black">
          Get In Touch
        </h1>
        <div className="flex flex-col md:flex-row items-center justify-center">
          <div className="md:w-1/2  w-full">
            <h1 className="text-2xl font-semibold lg:text-3xl capitalize text-center md:text-left">
            ...
            <div className="mt-6 space-y-8 md:mt-8">
              <p className="flex items-start -mx-2">
                ...
                <span className="mx-2  truncate  max-w-[12rem] md:max-w-xs lg:max-w-md">
            ...
            <div className="flex items-center justify-start gap-4 w-full mt-4 md:mt-6">
              <ul className="flex items-center justify-center space-x-4">
                ...
                <li>
                  ...
                  >
                    <ImLinkedin className="w-8 h-8 text-gray-800" />
                  </a>
                </li>
                <li>
                  <a
          ...
          <div className="pt-12 lg:w-1/2 w-full lg:mt-0">
            ...
            <form className="mt-8 space-y-5">
              <input
                ...
                className="block w-full bg-gray-100 h-14 px-4 rounded-xl focus:outline-none focus:border-blue-500"
              />
              <input
                type="email"
              ...
              <textarea
                ...
                className="block w-full bg-gray-100 h-32 px-4 py-4 rounded-xl focus:outline-none focus:border-blue-500"
              ></textarea>
